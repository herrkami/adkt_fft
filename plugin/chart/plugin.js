...
const initChart = function (Reveal) {
	...
	*/
	...
	/*
	* Recursively crawls through the data object and searches for string values
	* describing self-executing functions, specifically strings that start with
	* '(() =>'). It then evaluates them and overwrites the entry by the result.
	*/
	function evalCodeStrings(data) {
		for (k of Object.keys(data)) {
			if (typeof data[k] === 'object') evalCodeStrings(data[k]);
